...
import 'package:ingenieria_flutter/User/ui/screens/login_page.dart';
import 'package:ingenieria_flutter/User/ui/screens/sign_in_screen.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  checkLoginStatus() async {
    ...
    if(sharedPreferences.getString("accessToken") == null || !sharedPreferences.getBool("isLogin")) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("App Ciisa", style: TextStyle(color: Colors.white)),
        actions: <Widget>[
          FlatButton(
            onPressed: () {
